...
export default function Header() {
  ...
  return (
    <>
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-neutral-900 z-50 transform transition-transform duration-300 md:hidden shadow-xl ${
      ...
      {/* Header */}
      <header
        className={`sticky top-0 z-40 bg-white/80 dark:bg-black/40 backdrop-blur-md shadow-md transition-all duration-300 ${
      ...
      >
        {/* Place your page <main> here so it gets pushed when sidebar opens */}
      </div>
    </>
  )
}
