...
`,
  ...
  const schema = {
    ...
    '@type': 'Service',
    serviceType: 'Web Design, Web Development, SEO, Branding',
    provider: {
      '@type': 'Organization',
      name: 'Syntax Tech',
    ...
    areaServed: 'Nigeria',
    description:
      'Syntax Tech provides professional website design, web development, SEO, branding and digital solutions for businesses and individuals.',
  }
  ...
  return (
    <>
      <Head>
        <title>
          Web Designer &amp; Developer in Nigeria | Syntax Services (Web Design,
          SEO, Branding)
        </title>
        <meta
          name="description"
          content="Hire Syntax Tech for professional web design, web development, SEO optimisation, branding, ecommerce stores & custom apps. Get your website built today."
        />
        <meta
          name="keywords"
          content="web designer, web developer, website management, Syntax Tech, website designer near me, website developer near me, SEO services Nigeria, branding, ecommerce websites"
        />
        <link rel="canonical" href="https://syntax.com.ng/services" />
        <script
      ...
      <main className="bg-syntaxCream dark:bg-syntaxDark text-syntaxDark dark:text-syntaxCream min-h-screen">
        ...
        <section className="max-w-6xl mx-auto px-4 py-16 md:py-24 text-center">
          ...
          >
            Professional{' '}
            <span className="text-syntaxBlue">
          ...
          >
            From responsive websites to full-scale applications — Syntax builds
            high-performing digital experiences with SEO, branding & growth
            built-in.
          </motion.p>
        </section>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              >
                ...
                <span className="mt-2 text-syntaxBlue font-semibold">
                  {s.price}
                </span>
                {s.custom && (
                  <button
          ...
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-neutral-900 rounded-[2.5rem] max-w-2xl w-full p-6 sm:p-8 relative shadow-2xl">
              ...
              <p className="text-xs sm:text-base mb-6">
                Tell us what kind of site or application you’re looking for.
                Select features and describe your idea so we can build exactly
                what you want.
              </p>
