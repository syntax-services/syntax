  ...
  return (
    <>
      ...
      <div className="top-header-wrapper">
        ...
        >
          <Link href="/demos/tml" className="top-brand-standalone">
        ...
        <div className="top-actions-pill-fixed">
          ...
          <ul className="nav-links-pill desktop-nav-links">
            <li>
              <Link href="/demos/tml" className={pathname === '/' ? 'active' : ''}>Home</Link>
            </li>
            <li>
              <Link href="/demos/tml/shop" className={pathname === '/shop' ? 'active' : ''}>Shop</Link>
            </li>
            <li>
              <Link href="/demos/tml/about" className={pathname === '/about' ? 'active' : ''}>About</Link>
            </li>
            <li>
              <Link href="/demos/tml/contact" className={pathname === '/contact' ? 'active' : ''}>Contact</Link>
            </li>
          </ul>
      ...
      <div className="mobile-bottom-nav-dock-micro">
        <Link href="/demos/tml" className={`bottom-dock-micro-item ${pathname === '/' ? 'active' : ''}`}>
          <Home size={14} />
          <span>Home</span>
        </Link>
        <Link href="/demos/tml/shop" className={`bottom-dock-micro-item ${pathname === '/shop' ? 'active' : ''}`}>
          <LayoutGrid size={14} />
          <span>Shop</span>
        </Link>
        <Link href="/demos/tml/about" className={`bottom-dock-micro-item ${pathname === '/about' ? 'active' : ''}`}>
          <Info size={14} />
          <span>About</span>
        </Link>
        <Link href="/demos/tml/contact" className={`bottom-dock-micro-item ${pathname === '/contact' ? 'active' : ''}`}>
