      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '40px', textAlign: 'left', marginBottom: '40px' }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.88rem' }}>
            <li><Link href="/demos/tml/shop" style={{ color: 'var(--text-primary)', textDecoration: 'none' }}>Shop Catalog</Link></li>
            <li><Link href="/demos/tml/about" style={{ color: 'var(--text-primary)', textDecoration: 'none' }}>About TML</Link></li>
            <li><Link href="/demos/tml/contact" style={{ color: 'var(--text-primary)', textDecoration: 'none' }}>WhatsApp Support</Link></li>
          </ul>
        </div>
