...
import { ShoppingBag, ArrowRight, ShieldCheck, Zap, X } from 'lucide-react'
...
export default function MimmsCartelHomePage() {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-sm md:text-base text-neutral-400 leading-relaxed max-w-lg">
              Handcrafted for effortless luxury and all-day style. Each pair is built from full-grain leathers and premium suede.
            </p>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto border-t border-neutral-900">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mt-1">Handcrafted Leather Footwear</h2>
          </div>
          <Link
            href="/demos/mimmscartel/shop"
